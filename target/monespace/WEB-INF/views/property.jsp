...
<body ng-app="myApp" ng-controller="myController">
	...
	<form:form method="POST" action="add/property"
		...
		<form:select path="dealsCategory.dealsCategoryName"
		...
		<form:input path="multipartImage" type="file" />
