...
//		property.setDealerId(dealer.getDealerId());
		...
		//*******************MultipartImage*********************
//		String path="D:\\workspace28\\monespace\\src\\main\\webapp\\resources\\img\\properties";
//		path=path+String.valueOf(property.getPropertyId())+".jpg";
//		File f=new File(path);
//		System.out.println("path is"+path);
//		MultipartFile mf=property.getUploadImage();
//		if(!mf.isEmpty()) {
//			
//			try {
//				
...
//	}
	...
	String path="D:\\workspace28\\monespace\\src\\main\\webapp\\resources\\img\\properties\\property";
