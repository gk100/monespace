...
<body>
	...
	<form:form method="POST" action="add/subCategory" modelAttribute="dealsSubCategory">
	<form:input path="dealsSubCategoryId" hidden="true"/>
		<table>
			<tr>
...
<!-- 			</tbody> -->
<!-- 		</table> -->
	<div ng-app="getDealsSubCategory" ng-controller="DealsSubCategoryController">
		<table>
			<tbody>
				<tr>
					<th>DEALS_SUB_CATEGORY_ID</th>
					<th>DEALS_SUB_CATEGORY_NAME</th>
				</tr>
				<tr>
					<tr ng-repeat="s in subCategory">
					<td>{{s.dealsSubCategoryId}}</td>
					<td>{{s.dealsSubCategoryName}}</td>
				</tr>
			</tbody>
		</table>
		<br> <br>
	...
	<script>
						angular.module('getDealsSubCategory', []).controller(
								'DealsSubCategoryController', function($scope) {
									$scope.subcategory = ${ListDealsCategories}
								});
					</script>
</body>
</html>