...
<form:form method="POST" action="add/dealscategories" commandName="dealsCategories" modelAttribute="dealsCategories">
   <table>
    <tr>
...
<table>
<tbody>
<tr><th>DEALSCATEGORYID</th><th>DEALSCATEGORYDESCRIPTION</th><th>DEALSCATEGORYNAME</th></tr>
<c:forEach items="${listDealsCategories}" var="DealsCategory">
<tr><td><c:out value="${DealsCategory.dealsCategoryId}"></c:out></td>
<td><c:out value="${DealsCategory.dealsCategoryname}"></c:out></td>
<td><c:out value="${DealsCategory.dealsCategoryDescription}"></c:out></td></tr>
</c:forEach>
</tbody>
</table>
<br><br>
